    ...
    return (
        <div className='grid container mx-auto grid-cols-1 sm:p-4 md:grid-cols-2'>
            <div className='mt-32'>
                ...
                <button className='w-6/12 flex m-auto'><img src="images/Emoticons/big-button.png" alt="button" /></button>
                <button className='w-2/6 mt-12 flex m-auto'><img src="images/Emoticons/badge-new-min.png" alt="button" /></button>
            </div>
            <div className='mt-6'>
                <img className='m-auto' src="images/Emoticons/First-Page-550.png" alt="phone" />
            </div>
        </div>
    );
};

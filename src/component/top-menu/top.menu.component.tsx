    ...
    return (
        <div>
            <div className='flex justify-end'>
                <img className='ml-5' src="images/Emoticon/icons8-facebook-circled-24.png" alt="mobile icone" />
                <img className='ml-5' src="images/Emoticon/icons8-twitter-24.png" alt="mobile icone" />
